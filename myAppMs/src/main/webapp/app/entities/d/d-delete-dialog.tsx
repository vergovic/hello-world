...
export const DDeleteDialog = () => {
  ...
  const dEntity = useAppSelector(state => state.myappms.d.entity);
  const updateSuccess = useAppSelector(state => state.myappms.d.updateSuccess);
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myAppMsApp.d.delete.question">
        <Translate contentKey="myAppMsApp.d.delete.question" interpolate={{ id: dEntity.id }}>
