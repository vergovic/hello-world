...
export const D = () => {
  ...
  const dList = useAppSelector(state => state.myappms.d.entities);
  const loading = useAppSelector(state => state.myappms.d.loading);
  ...
  return (
    <div>
      <h2 id="d-heading" data-cy="DHeading">
        <Translate contentKey="myAppMsApp.d.home.title">DS</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="myAppMsApp.d.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/d/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="myAppMsApp.d.home.createLabel">Create new D</Translate>
          </Link>
        </div>
      </h2>
        ...
        {dList && dList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="myAppMsApp.d.id">ID</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="myAppMsApp.d.home.notFound">No DS found</Translate>
            </div>
          )
        )}
      </div>
